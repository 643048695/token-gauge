...
window.I18N = (function () {
  var EN = {
    ...
    '每个供应商的余额都存在它的 API 里，TokenGauge 负责抓回来、画成屏。': "Each provider's balance lives in its own API; TokenGauge fetches and renders it.",
    '供应商 API': 'Provider API',
    '余额 · 用量': 'Balance · Usage',
    '都在云端账户里': 'Stored in your cloud account',
    'TokenGauge 本地抓取': 'TokenGauge fetches locally',
    '定时同步': 'Scheduled sync',
    ...
    '给 TokenGauge 添加一个 DeepSeek 供应商': 'Add a DeepSeek provider to TokenGauge',
    '它会调': 'It will run',
