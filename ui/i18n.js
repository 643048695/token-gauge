...
window.I18N = (function () {
  var EN = {
    ...
    ' 小时': ' hours',
    '🌱 萌芽': '🌱 Sprouting',
    '🌬️ 风扇转动': '🌬️ Fan spinning',
    '🚗 上路行驶': '🚗 On the road',
    '🏭 重工业': '🏭 Heavy industry',
    '⚡ 全负荷': '⚡ Full load',
    '今日电量还很少': 'Still a small draw today',
    '今日 ≈ 风扇转 ': 'Today ≈ fan for ',
    '今日 ≈ 汽车行驶 ': 'Today ≈ car drove ',
    ' 公里': ' km',
    '今日 ≈ 工厂开工': 'Today ≈ factory running',
    '今日 ≈ 满负荷运转': 'Today ≈ running at full load',
      '跳过引导': 'Skip guide',
