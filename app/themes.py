...
STYLES = {
    ...
    "8bit": {
        ...
        "css": (
            ...
            "text-shadow:2px 2px 0 #000,4px 4px 0 rgba(0,0,0,0.4);font-family:Consolas,monospace}"
            "body[data-style='8bit'] input,body[data-style='8bit'] select{background:var(--bg);"
            "border:2px solid var(--border);color:var(--text);border-radius:0;font-family:Consolas,monospace}"
    ...
    "matrix": {
        ...
        "vars": dict(_MATRIX),
        "css": (
            "body[data-style='matrix']{background:#000;font-family:Consolas,'Courier New',monospace}"
            ...
            "background:var(--panel);letter-spacing:2px;font-family:Consolas,monospace}"
            ...
            "color:var(--text);border-radius:0;font-family:Consolas,monospace}"
    ...
    "redacted": {
        ...
        "css": (
            ...
            "font-family:'Courier New',monospace;font-size:9px;letter-spacing:2px;color:rgba(139,44,31,0.5);"
            ...
            "body[data-style='redacted'] .page-head h1{font-family:'Courier New',monospace;"
            ...
            "color:#3a3128;border-radius:0;font-family:'Courier New',monospace}"
